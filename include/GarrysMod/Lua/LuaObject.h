...
namespace GarrysMod
{
	namespace Lua
	{
		...
		public:
			...
			virtual void SetMember( const char *name, void *obj ) = 0;
			...
			virtual ILuaObject *GetMember( const char *name, void*niger ) = 0;
			virtual ILuaObject *GetMember( ILuaObject *key, void*niger) = 0;
